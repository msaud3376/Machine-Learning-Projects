...
if st.button("Predict"):
    ...
    st.markdown('<p style="font-size: 20px;">Predicted Selling Car Price is around</p> <p style="color: skyblue ;font-size: 20px;"> Rs '+ str(round(selling_price_predicted[0][0]*(10**5),2))+"</p>",unsafe_allow_html=True)
